...
/*
    HelperConfig contractı her çağırıldığında constructor da otomatik olarak çalışır.
    Dolayısıyla içindeki if bloğu şu an hangi ağda olduğumuzu anlayıp ona göre configi ayarlar.
    Config ise bize içinde bulunduğumuz ağa uygun   price feed adresini verir.
    Teknoloji müthiş.
 */
